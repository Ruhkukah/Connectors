...
int main() {
    try {
        ...
        moex::twime_sbe::test::require(codec.encode_message(enum_request, bytes) ==
        ...
        moex::twime_sbe::test::require(codec.encode_message(set_request, bytes) ==
                                           moex::twime_sbe::TwimeDecodeError::Ok,
        ...
        moex::twime_sbe::test::require(codec.encode_message(set_request, bytes) ==
                                           moex::twime_sbe::TwimeDecodeError::InvalidSetValue,
