...
int main() {
    try {
        ...
        establish_request.fields.push_back(
            {"KeepaliveInterval", moex::twime_sbe::TwimeFieldValue::delta_millisecs(1000)});
        establish_request.fields.push_back({"Credentials", moex::twime_sbe::TwimeFieldValue::string("LOGIN")});
        moex::twime_sbe::test::require(codec.encode_message(establish_request, bytes) ==
        ...
        missing_required.fields.erase(std::remove_if(missing_required.fields.begin(), missing_required.fields.end(),
                                                     [](const auto& field) { return field.name == "Price"; }),
                                      missing_required.fields.end());
        moex::twime_sbe::test::require(codec.encode_message(missing_required, bytes) ==
                                           moex::twime_sbe::TwimeDecodeError::InvalidFieldValue,
        ...
        moex::twime_sbe::test::require(codec.encode_message(long_account, bytes) ==
        ...
        moex::twime_sbe::test::require(codec.encode_message(embedded_zero, bytes) ==
                                           moex::twime_sbe::TwimeDecodeError::Ok,
        ...
        moex::twime_sbe::test::require(account_field->value.string_view().size() == 4,
                                       "embedded zero length not preserved");
        ...
        moex::twime_sbe::test::require(codec.decode_message(invalid_string, decoded) ==
                                           moex::twime_sbe::TwimeDecodeError::InvalidStringEncoding,
