<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/messageSchema">
        <html>
            <head>
            ...
            <body style="padding: 1rem; padding-top: 1rem">
                ...
                <h4>version = "<xsl:value-of select="/messageSchema/@version"/>",
                id = "<xsl:value-of select="/messageSchema/@id"/>"</h4>
                <hr/>
                <h2>
                    <a href="#Messages">Messages</a>
                </h2>
                <ul style="list-style-type:circle">
                    <xsl:for-each select="/messageSchema/message">
                        <li>
                            <a href="#{@name}">
                ...
                <ul style="list-style-type:circle">
                    <xsl:for-each select="/messageSchema/types/enum">
                        <li>
                            <a href="#{@name}">
                                <xsl:value-of select="@name"/>
                            </a>
                ...
                <ul style="list-style-type:circle">
                    <xsl:for-each select="/messageSchema/types/set">
                        <li>
                            <a href="#{@name}">
                                <xsl:value-of select="@name"/>
                            </a>
                ...
                <ul style="list-style-type:circle">
                    <xsl:for-each select="/messageSchema/types/composite">
                        <li>
                            <a href="#{@name}">
                                <xsl:value-of select="@name"/>
                            </a>
                ...
                <table width="80%">
                    ...
                    <xsl:for-each select="/messageSchema/types/type">
                        <tr class="with-border">
                            <td>
								<a name="{@name}">
                                    <xsl:value-of select="@name"/>
