...
#ifdef MOEX_AGGR_OBSERVATION_20260911
constexpr int kObservationDay = 11;
constexpr const char* kObservationToken = "20260911_AGGREGATED_OBSERVATION";
constexpr const char* kRunId = "aggr-t1-20260911";
constexpr const char* kProfileId = "main-aggregated-t1-20260911";
constexpr std::uint32_t kIdentityBase = 2026091100;
#else
